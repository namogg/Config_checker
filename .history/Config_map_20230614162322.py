...
def show_diff_config(officil_path, demo_path): 
...
for file in common_elements:
    official_path = os.join(folder_path_official,file)
    demo_path = os.join(folder_path_demo,file)
    show_diff_config(officail_path,)
...
def show_diff_file(officail_path, demo_path): 
...
def main():
    ...
    for officail_path, demo_path in zip(folder_path_official,folder_path_demo): 
        show_diff_file(officail_path, demo_path)
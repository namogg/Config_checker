...
official_files = get_file_names(folder_path_official)
demo_files = get_file_names(folder_path_demo)

#In ra các file có trong official
print(set(official_files) - set(demo_files))
print(set(demo_files) - set(official_files))